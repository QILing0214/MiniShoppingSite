...
<html>
<head>
  <link rel="stylesheet" type="text/css" href="/SiteClient/css/searchbar.css">
	...
	<script type="text/Javascript">
		$(document).ready(function() {
			//alert("0");
				...
				$.get("http://localhost:8080/findbyCatalog?catalog=phone" , function (data1) {
					...
					var len = data.length
				        for (var i=0; i<len; i++) {
					        ...
					        $("#quote").append("<img src=\"/SiteClient/images/phone/"+data[i].photo+"\">");//$("#picture").append("<img src=\" + returnData.img_url + "\" />");
				...
				$("#submit").click(function () 
						  {
							...
							$.ajax({
								...
								data:{"pname":search,"catalog":"phone"},
...
<body>
    ...
    <div id="header" align="center">
       <h2>Minishop</h2>
        ...
        Search phone: <input id="search" name="search" type="text">
   ...
   <div class="logout" >
    ...
    <div class="container" >
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="/SiteClient/jsp/catalog/computer.jsp">Computer</a></li>
