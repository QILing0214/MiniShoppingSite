	...
	<script type="text/Javascript">
		$(document).ready(function() {
			//alert("0");
				...
				$.get("http://localhost:8080/findbyCatalog?catalog=sport" , function (data1) {
					...
					var len = data.length
				        for (var i=0; i<len; i++) {
				        	 ...
				        	 $("#quote").append("<li><strong><a href=\"/SiteClient/jsp/productdetail.jsp?data="+data[i].pid+"\">"+data[i].pname + "</a></strong></li >");
						        $("#quote").append("<img src=\"/SiteClient/images/sport/"+data[i].photo+"\">");//$("#picture").append("<img src=\" + returnData.img_url + "\" />");
				...
				$("#submit").click(function () 
						  {
							...
							$.ajax({
								...
								data:{"pname":search,"catalog":"sport"},
...
<body>
    ...
    <div id="header" align="center">
       <h2>Minishop</h2>
        ...
        Search sport: <input id="search" name="search" type="text">
